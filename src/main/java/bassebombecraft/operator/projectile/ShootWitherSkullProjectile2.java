 ...
 */
public class ShootWitherSkullProjectile2 implements Operator2 {
	 ...
	 */
	public ShootWitherSkullProjectile2(Function<Ports, LivingEntity> fnGetInvoker, Function<Ports, Vec3d[]> fnGetOrientation) {
	 ...
	 * ports.
	 */
	public ShootWitherSkullProjectile2() {
