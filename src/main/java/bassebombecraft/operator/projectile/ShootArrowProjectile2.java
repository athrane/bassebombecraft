 ...
 */
public class ShootArrowProjectile2 implements Operator2 {
	 ...
	 */
	public ShootArrowProjectile2(Function<Ports, LivingEntity> fnGetInvoker, Function<Ports, Vec3d[]> fnGetOrientation) {
