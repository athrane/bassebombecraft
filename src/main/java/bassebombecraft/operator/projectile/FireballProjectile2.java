 ...
 */
public class FireballProjectile2 implements Operator2 {
	 ...
	 */
	public FireballProjectile2(Function<Ports, LivingEntity> fnGetInvoker, Function<Ports, Vec3d[]> fnGetOrientation) {
