...
import static bassebombecraft.config.ModConfiguration.lavaSpiralMistEffectDuration;
...
public class LavaSpiralMistBook extends GenericRightClickedBook {
	...
	static Supplier<Integer> splDuration = () -> lavaSpiralMistEffectDuration.get();
