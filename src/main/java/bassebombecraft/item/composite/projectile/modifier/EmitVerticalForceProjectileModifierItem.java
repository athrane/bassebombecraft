...
import static bassebombecraft.config.ModConfiguration.emitVerticalForceProjectileModifierItem;
...
/**
 * Emit vertical force projectile modifier item.
 * 
 * The tagged projectile is processed in
 * {@linkplain ProjectileModifierEventHandler} where the
 * {@linkplain EmitVerticalForce2} operator is executed.
 */
public class EmitVerticalForceProjectileModifierItem extends GenericCompositeNullItem {

	/**
	 * Item identifier.
	 */
	public static final String NAME = EmitVerticalForceProjectileModifierItem.class.getSimpleName();
	...
	static Supplier<Operator2> splOp = () -> {
		...
		Function<Ports, String> fnGetTag = p -> EmitVerticalForce2.NAME;
