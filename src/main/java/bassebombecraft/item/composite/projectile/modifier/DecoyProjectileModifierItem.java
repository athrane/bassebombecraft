...
import static bassebombecraft.config.ModConfiguration.decoyProjectileModifierItem;
...
/**
 * Decoy projectile modifier item.
 * 
 * The tagged projectile is processed in
 * {@linkplain ProjectileModifierEventHandler} where the
 * {@linkplain SpawnDecoy2} operator is executed.
 */
public class DecoyProjectileModifierItem extends GenericCompositeNullItem {

	/**
	 * Item identifier.
	 */
	public static final String NAME = DecoyProjectileModifierItem.class.getSimpleName();
	...
	static Supplier<Operator2> splOp = () -> {
		...
		Function<Ports, String> fnGetTag = p -> SpawnDecoy2.NAME;
