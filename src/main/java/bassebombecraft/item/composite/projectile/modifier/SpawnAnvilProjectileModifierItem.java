...
import static bassebombecraft.config.ModConfiguration.spawnAnvilProjectileModifierItem;
...
/**
 * Falling anvil projectile modifier item.
 * 
 * The tagged projectile is processed in
 * {@linkplain ProjectileModifierEventHandler} where the
 * {@linkplain SpawnAnvil2} operator is executed.
 */
public class SpawnAnvilProjectileModifierItem extends GenericCompositeNullItem {

	/**
	 * Item identifier.
	 */
	public static final String NAME = SpawnAnvilProjectileModifierItem.class.getSimpleName();
	...
	static Supplier<Operator2> splOp = () -> {
		...
		Function<Ports, String> fnGetTag = p -> SpawnAnvil2.NAME;
