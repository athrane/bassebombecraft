...
public class DebugTextBillBoardRenderer implements EntityRenderer {
	...
	public void render(LivingEntity entity, RenderingInfo info) {
		...
		BassebombeCraft.getBassebombeCraft().getLogger()
				.debug("rve-translated with player offset=" + info.getRveTranslatedViewX() + ","
						+ info.getRveTranslatedViewYOffsetWithPlayerEyeHeight() + "," + info.getRveTranslatedViewZ());
		...
		BassebombeCraft.getBassebombeCraft().getLogger()
				.debug("RenderViewEntity=" + activeRenderInfo.getRenderViewEntity());
		BassebombeCraft.getBassebombeCraft().getLogger()
				.debug("RenderViewEntity.lookVec=" + activeRenderInfo.getRenderViewEntity().getLookVec());
		BassebombeCraft.getBassebombeCraft().getLogger()
				.debug("RenderViewEntity.positionVec=" + activeRenderInfo.getRenderViewEntity().getPositionVec());
		 ...
		 * "TEXT at (1,4,4)"); renderHudTextBillboard(translation,
		 * textTranslation.add(0, -2, 0), "TEXT at (5,2,4)");
		 ...
		 * (1,4,4)"); renderHudTextBillboard(translation, textTranslation.add(0, -2, 0),
		 ...
		 * at (1,4,4)"); renderHudTextBillboardV2(textTranslation.add(0, -2, 0),
		 * "V2-TEXT at (5,2,4)"); renderHudTextBillboardV2(textTranslation.add(0, -4,
		 * 0), "V2-TEXT at (5,0,4)");
		 **/
		 ...
		 * 
		 * int i1 = (scaledWidth - mc.fontRenderer.getStringWidth("V3-TEXT at (-20,0)"))
		 * / 2; int j1 = scaledHeight - 31 - 4;
	...
	void renderHudTextBillboardV2a(Vec3d textTranslation, String text) {
		...
		// scale text
		RenderSystem.scaled(ClientModConstants.TEXT_SCALE, ClientModConstants.TEXT_SCALE,
				ClientModConstants.TEXT_SCALE);
	...
	void renderHudTextBillboardV3(String text, int x, int y) {
		...
		// draw
		Minecraft mc = Minecraft.getInstance();
		mc.fontRenderer.drawString(text, x, y, ClientModConstants.TEXT_COLOR);
	...
	void renderHudTextBillboard(Vec3d cameraTranslation, Vec3d textTranslation, String text) {
		...
		// scale text
		GlStateManager.scalef(ClientModConstants.TEXT_SCALE, ClientModConstants.TEXT_SCALE,
				ClientModConstants.TEXT_SCALE);
