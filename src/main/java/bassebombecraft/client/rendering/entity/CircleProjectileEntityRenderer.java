 ...
 */
public class CircleProjectileEntityRenderer extends EntityRenderer<CircleProjectileEntity> {
	 ...
	 * Path to texture.
	 */
	static final ResourceLocation TEXTURE = createTextureResourceLocation(CircleProjectileEntity.class);
	...
	@Override
	public void render(CircleProjectileEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
	...
	@Override
	protected int getBlockLight(CircleProjectileEntity entityIn, float partialTicks) {
		return 15;
	}
