 ...
 */
public class LightningProjectileEntityRenderer extends EntityRenderer<LightningProjectileEntity> {
	 ...
	 * Path to texture.
	 */
	static final ResourceLocation TEXTURE = createTextureResourceLocation(LightningProjectileEntity.class);
	...
	@Override
	public void render(LightningProjectileEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
	...
	@Override
	protected int getBlockLight(LightningProjectileEntity entityIn, float partialTicks) {
		return 15;
	}
