 ...
 */
public class EggProjectileEntityRenderer extends EntityRenderer<EggProjectileEntity> {
	...
	@Override
	public void render(EggProjectileEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
	...
	@Override
	protected int getBlockLight(EggProjectileEntity entityIn, float partialTicks) {
		return 15;
	}
