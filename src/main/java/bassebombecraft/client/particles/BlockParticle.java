...
public class BlockParticle extends TextureSheetParticle {
	...
	BlockParticle(ClientLevel worldIn, double posXIn, double posYIn, double posZIn) {
		super(worldIn, posXIn, posYIn, posZIn);
	}

	BlockParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn,
