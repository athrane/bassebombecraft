...
/**
 * Relfect damage particle.
 * 
 * Supports animation based on age.
 * 
 * The set of animation frames are defined in the the .json file.
 */
public class ReflectParticle extends SpriteTexturedParticle {

	/**
	 * Particle identifier.
	 */
	public static final String NAME = ReflectParticle.class.getSimpleName();
	...
	protected ReflectParticle(World worldIn, double posXIn, double posYIn, double posZIn) {
		super(worldIn, posXIn, posYIn, posZIn);
	}

	protected ReflectParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn,
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle makeParticle(BasicParticleType typeIn, ClientWorld world, double x, double y, double z,
			...
			ReflectParticle particle = new ReflectParticle(world, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
