...
public class SkullParticle extends TextureSheetParticle {
	...
	SkullParticle(ClientLevel worldIn, double posXIn, double posYIn, double posZIn) {
		super(worldIn, posXIn, posYIn, posZIn);
	}

	SkullParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn,
